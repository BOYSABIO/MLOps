...
def main(cfg: DictConfig):
    ...
    if cfg.step not in VALID_STEPS:
        logging.error(f"Unknown step '{cfg.step}'. Must be one of: {VALID_STEPS}")
        return

    # Résolution absolue des chemins de fichiers/dossiers
    ...
    # Chemins spécifiques aux fichiers NPY
    ...
    # Lancement des modules avec MLflow
